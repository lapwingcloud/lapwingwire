...
func (tq *TagQuery) QueryAgents() *AgentQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, tag.AgentsTable, tag.AgentsPrimaryKey...),
		)
...
func (tq *TagQuery) Clone() *TagQuery {
	...
	return &TagQuery{
		...
		withAgents: tq.withAgents.Clone(),
...
func (tq *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := tq.withAgents; query != nil {
		if err := tq.loadAgents(ctx, query, nodes,
			func(n *Tag) { n.Edges.Agents = []*Agent{} },
			func(n *Tag, e *Agent) { n.Edges.Agents = append(n.Edges.Agents, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TagQuery) loadAgents(ctx context.Context, query *AgentQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Agent)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(tag.AgentsTable)
		s.Join(joinT).On(s.C(agent.FieldID), joinT.C(tag.AgentsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(tag.AgentsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(tag.AgentsPrimaryKey[1]))
